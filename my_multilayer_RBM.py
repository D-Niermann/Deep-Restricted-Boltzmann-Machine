...
class DBM_class(object):
	...
	def test(self,test_data):
		...
		# "verarsche" tf graph init weil h2 einfach nur für die erste def gebraucht wird im graph und danach anders definiert
...
load_from_file        = 1
pathsuffix            = "Thu Jan 18 17-22-41 2018"
...
if plotting:
	...
	fig3,ax3 = plt.subplots(6,16,figsize=(16,4),sharey="row")
	for i in range(16):
		# plot the input
		...
		ax3[4][i].bar(range(10),DBM.h2_test[i])
	...
	#plot only one digit
	fig4,ax4 = plt.subplots(6,10,figsize=(16,4),sharey="row")
	m=0
	for i in index_for_number[0:10]:
		...
		ax4[4][m].bar(range(10),DBM.h2_test[i])
		#plot the reconstructed layer h1
