...
update_bias_v = bias_v.assign(bias_v+learnrate/1000.*tf.reduce_mean(v-v_recon,0))
update_bias_h = bias_h.assign(bias_h+learnrate/1000.*tf.reduce_mean(h-h_gibbs,0))
