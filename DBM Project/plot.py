...
files_to_load=["test_error_mean.txt"]


class container(object):
	def load_files(self,directory):
		os.chdir(data_dir+directory)
		log.out("Changed dir to: ",directory)
...
for i in range(len(conts)):
	plt.plot(conts[i].epochs_train,conts[i].class_error_mean,"o")
plt.show()
