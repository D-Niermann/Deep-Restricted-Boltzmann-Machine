...
UserSettings = {
	...
	#### Which Dataset to load 
		"DO_CLASSIFICATION" : 0,					# if the last layer is a classification layer or not
	...
	# training process
		...
		"N_EPOCHS_PRETRAIN"  : [30,0,0,0,0,0], 		# pretrain epochs for each RBM
	...
	### state vars
		...
		"DROPOUT_RATE" : 0,							# multiplication of random uniform synaptic failure matrix (higher number -> less failure)
