...
def update_l_s_glauber():
    """ kann ja nicht klappen weil update_l_s ja auch schon ne liste ist und der die parallel macht"""
    layer_numbers = range(DBM.n_layers)
    layer_numbers = rnd.shuffle(layer_numbers)
    return [self.update_layer_s[i] for i in layer_numbers]
