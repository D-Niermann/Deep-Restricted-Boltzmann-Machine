...
class DBM_class(object):
	...
	def graph_init(self,graph_mode):
		...
		self.mean_w1 = tf.reduce_mean(tf.square(self.w[0]))
	...
	def test(self,test_data,test_label,N,M):
		...
		for n in range(N):
			h1[n], h2[n], label[n]  = sess.run(self.update_l_s[1:], {self.temp : temp})
...
load_from_file        = 1
pathsuffix            = r"Thu_Mar_22_12-12-09_2018_[784, 225, 50, 10]"#"Sun Feb 11 20-20-39 2018"#"Thu Jan 18 20-04-17 2018 80 epochen"
pathsuffix_pretrained = r"Thu_Mar_22_11-49-55_2018"
